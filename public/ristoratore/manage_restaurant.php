...
<body>
    ...
    <div class="main-content">
        ...
        <div class="top-header">
            ...
            <?php if ($msg): ?>
                <div
                    style="background:white; padding:10px 20px; border-radius:10px; color:green; font-weight:bold; box-shadow: 0 5px 15px rgba(0,0,0,0.05);">
...
>>>>>>> c802af9bf93c87dcb53a5d003d8a8096230c1c57
            ...
            <div class="card" style="background: transparent; box-shadow: none; padding: 0;">
                ...
                <?php if (empty($orders)): ?>
                    <div
                        style="text-align:center; padding:50px; background:white; border-radius:20px; box-shadow: 0 18px 40px rgba(112, 144, 176, 0.12);">
                        ...
                        <div class="order-card">
                            <div class="order-header">
                                <div>
                                    ...
                                    <div class="order-time"><?php echo date("d/m H:i", strtotime($order['created_at'])); ?>
                                    </div>
                                </div>
                                <div>
                                    <?php
