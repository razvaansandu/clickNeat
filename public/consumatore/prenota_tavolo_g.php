...
<body>
    ...
    <header class="hero-section">
        <div class="hero-content">
            <a href="dashboard_consumatore.php" id="btn-back" class="btn-back-hero">
    ...
    <div class="main-container">
        ...
        <div class="card-style" style="margin-bottom: 28px;">
        ...
        <div class="card-style" id="success-box" style="display:none; text-align:center; padding: 50px 30px;">
            ...
            <div style="display:flex; gap:16px; justify-content:center; flex-wrap:wrap;">
                ...
                <a href="dashboard_consumatore.php" style="padding:12px 28px; background:#F4F7FE; color:#1A4D4E; border-radius:12px; font-weight:600; display:inline-flex; align-items:center; gap:8px;">
    ...
    <script>
        var ristoranteId = new URLSearchParams(window.location.search).get('id') || 0;

        if (ristoranteId) {
            document.getElementById('btn-back').href = 'menu.php?id=' + ristoranteId;
        }
        ...
        function renderTavoli() {
            var grid = document.getElementById('tables-container');
        ...
        document.getElementById('input-data').max = maxDateStr;
        ...
        function cercaDisponibilita() {
            ...
            document.getElementById('step2-label').textContent = 'Tavoli disponibili';
            document.getElementById('step2-info').textContent =
                data ? (dataFormatted + ' alle ' + ora + ' \u2014 ' + persone + ' person' + (persone == 1 ? 'a' : 'e')) : '';
        ...
        function selezionaTavolo(id, nome, capacita) {
            selectedTavoloId = id;
            selectedTavoloNome = nome;

            document.querySelectorAll('.table-card').forEach(function(c) { c.classList.remove('selected'); });
            document.getElementById('table-card-' + id) && document.getElementById('table-card-' + id).classList.add('selected');
        ...
        function confermaPrenotazione() {
            ...
            document.getElementById('success-detail').textContent =
                selectedTavoloNome + ' \u2014 ' + dataFormatted + ' alle ' + ora + ' per ' + persone + ' person' + (persone == 1 ? 'a' : 'e');

            document.getElementById('step2').style.display = 'none';
            document.querySelectorAll('.card-style')[0].style.display = 'none';
