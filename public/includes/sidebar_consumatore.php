...
<div class="sidebar">
    ...
    <div class="nav-links">
        <a href="dashboard_consumatore.php"
           class="<?php echo basename($_SERVER['PHP_SELF']) == 'dashboard_consumatore.php' ? 'active' : ''; ?>">
            <i class="material-symbols-outlined">dashboard_2</i> Dashboard
        </a>

        <a href="history.php"
           class="<?php echo basename($_SERVER['PHP_SELF']) == 'history.php' ? 'active' : ''; ?>">
            <i class="fa-solid fa-clock-rotate-left"></i> Storico Ordini
        </a>

        <a href="profile_consumatore.php"
           class="<?php echo basename($_SERVER['PHP_SELF']) == 'profile_consumatore.php' ? 'active' : ''; ?>">
