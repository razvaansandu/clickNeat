...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(!$blocked){
        if(empty($username)){
            ...
            $sql = "SELECT id, username, password, ruolo, email_verified FROM users WHERE (username = ? OR email = ?) AND ruolo = 'ristoratore'";
...
<body>
    <div class="container">
        ...
        <p style="text-align: center;">
            Sei un consumatore? <a href="login_consumatore.php">Accedi come consumatore</a>
        </p>
    </div>
</body>
</html>
